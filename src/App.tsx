...
const lyricsWithTiming = [
  ...
  { time: 28, text: "I wish you the greatest happiness that can be in lot of love in this world.", interval: 6 },
  { time: 39, text: "You are my lover, partner and best friend forever. ❤️ ❤️", interval: 4 },
  { time: 45, text: "love you so much❤️ ❤️", interval: 10 },
